...
<?php
    ...
    if(isset($_GET['id_produit']))
    {
        ...
        if($produit['stock']>0)
        {
            ...
            echo '<form action="paniers.php" method="post">';
    ...
    echo"<a href='membre.php'> Voulez vous ajouter d'autres produits ?</a>";
    echo"<br>";
...
else
{
    ...
    echo"<td> <a href='paniers.php?id_produit_supprimer=$idprod'>
            <input type='button' class='btn btn-outline-danger' value='supprimer'>
        </a></td>";
    echo'<td><form action="modifpaniers.php" method="get"><button name="id_produit" class="btn btn-outline-success" value="'.$idprod.'">Modifier</button></form></td>';
    echo "</tr>";
    }
    ...
    echo "<tr><td colspan='6'><a href='details.php?action=vider'>Vider mon panier</a></td></tr>";
}
echo "</table><br />";
